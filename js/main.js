...
function commander(cmd) {
  switch (cmd) {
    ...
    case 'email':
      addLine(
        'Opening mailto:<a href="mailto:shibeswarsingha@gmail.com">shibeswarsingha@gmail.com</a>...',
        'color2',
        80
      );
      newTab(email);
